...
const objHanako = {
  "id": "satohanako",
  "name": "佐藤花子",
  "supervisor": "家の修繕のスーパーバイザー",
  "text": "建築士資格を持ち、20年以上のリフォーム業界経験を持つ佐藤花子は、住宅の修繕やリフォームのプロフェッショナルです。" +
          "設計から施工までを一貫してサポートし、省エネ改修やバリアフリーリフォームなど、最新の技術とトレンドに精通しています。" +
          "細部にまでこだわる丁寧な仕事が評判で、安心してお任せいただけます。おうちの修繕やリフォームは、佐藤花子にご相談ください。",
}
const objTaro = {
  "id": "tanakataro",
  "name": "田中太郎",
  "supervisor": "不動産のスーパーバイザー",
  "text": "田中太郎は30年以上の不動産業界経験を誇るベテランスーパーバイザーです。" +
          "土地や住宅の売買、賃貸、管理に関する豊富な専門知識を持ち、特に住宅ローンや資産運用のアドバイスには定評があります。" +
          "お客様のニーズに合わせた最適な不動産戦略を提案し、多くの顧客から信頼を得ています。"+
          "不動産に関するあらゆるご相談は、田中太郎にお任せください。"
}

const objIchiro = {
  "id": "tanakataro",
  "name": "",
  "supervisor": "介護のスーパーバイザー",
  "text": "鈴木一郎は、介護福祉士として25年のキャリアを持つスーパーバイザーです。" +
          "高齢者ケアや施設運営の専門知識が豊富で、特に認知症ケアや在宅介護の支援に力を入れています。" +
          "利用者とその家族に寄り添ったサポートを提供し、多くの実績を持つ鈴木一郎が、常に新しい介護技術の習得に努めながら、" +
          "安心して介護を受けられる環境を整えます。介護に関するご相談は、鈴木一郎にお任せください。"
}
const objMisaki = {
  "id": "takahashimisaki",
  "name": "高橋美咲",
  "supervisor": "終活・相続のスーパーバイザー",
  "text": "ファイナンシャルプランナー資格を持ち、15年以上の経験を誇る高橋美咲は、終活や相続に関する法的・財務的なアドバイスの専門家です。" +
          "遺言書作成や相続税対策、財産分割の相談に応じ、クライアントの意思を尊重したプランを提案します。" +
          "安心して終活を進められるよう、高橋美咲が全力でサポートいたします。終活や相続に関するご相談は、高橋美咲にお任せください。"
}
const objKenta = {
  "id": "nakamurakenta",
  "name": "中村健太",
  "supervisor": "車や保険・金融のスーパーバイザー",
  "text": "保険業界で20年以上の経験を持つ中村健太は、特に自動車保険や生命保険の分野に精通したスーパーバイザーです。" +
          "クライアントのライフスタイルに合わせた保険商品の提案や見直しを行い、最適な保障を提供します。" +
          "また、金融商品についても幅広い知識を持ち、資産運用やリスク管理のアドバイスも行っています。" +
  ...
  if (sessionStorage.getItem('AccountName') !== null) {
    return (
      <div>
        ...
        <Search />
        <ServiceDescription />
        <ContentItem id={objHanako} name={objHanako.name} text={objHanako.text} supervisor={objHanako.supervisor} imgUrl={hanakoImage}/>
        <ContentItem id={objTaro} name={objTaro.name} text={objTaro.text} supervisor={objTaro.supervisor} imgUrl={TaroImage}/>
        <ContentItem id={objIchiro} name={objIchiro.name} text={objIchiro.text} supervisor={objIchiro.supervisor} imgUrl={IchiroImage}/>
        <ContentItem id={objMisaki} name={objMisaki.name} text={objMisaki.text} supervisor={objMisaki.supervisor} imgUrl={MisakiImage}/>
        <ContentItem id={objKenta} name={objKenta.name} text={objKenta.text} supervisor={objKenta.supervisor} imgUrl={KentaImage}/>
        <Footer />
        <Toolbar />
      </div>
    );
