  ...
  return (
    ...
    <div className="App">
      ...
      <Search />
        ...
        <ContentItem text="保険業界で20年以上の経験を持つ中村健太は、特に自動車保険や生命保険の分野に精通したスーパーバイザーです。クライアントのライフスタイルに合わせた保険商品の提案や見直しを行い、最適な保障を提供します。また、金融商品についても幅広い知識を持ち、資産運用やリスク管理のアドバイスも行っています。車や保険、金融に関するご相談は、中村健太にお任せください。。どうぞお気軽にご利用ください。" imgUrl={KentaImage} name="車や保険・金融のスーパーバイザー - 中村健太郎" />
        <Footer />
        <Toolbar />
        ...
        <a href="#faq">FAQガイドライン <br></br>（よくある質問）</a>
