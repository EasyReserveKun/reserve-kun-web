...
function App() {
  ...
  return (
    ...
    <div className="App">
      ...
      <ContentItem 
        text={`田中太郎は30年以上の不動産業界経験を誇るベテランスーパーバイザーです.土地や住宅の売買、賃貸、管理に関する豊富な専門知識を持ち、特に住宅ローンや資産運用のアドバイスには定評があります。お客様のニーズに合わせた最適な不動産戦略を提案し、多くの顧客から信頼を得ています。不動産に関するあらゆるご相談は、田中太郎にお任せください。`} 
        imgUrl={TaroImage} 
        name="不動産のスーパーバイザー - 田中太郎" 
      />
      <ContentItem text="鈴木一郎は、介護福祉士として25年のキャリアを持つスーパーバイザーです。高齢者ケアや施設運営の専門知識が豊富で、特に認知症ケアや在宅介護の支援に力を入れています。利用者とその家族に寄り添ったサポートを提供し、多くの実績を持つ鈴木一郎が、常に新しい介護技術の習得に努めながら、安心して介護を受けられる環境を整えます。介護に関するご相談は、鈴木一郎にお任せください。
" imgUrl={IchiroImage} name="介護のスーパーバイザー - 鈴木一郎" />
